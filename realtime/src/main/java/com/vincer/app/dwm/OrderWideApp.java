package com.vincer.app.dwm;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.vincer.app.func.DimAsyncFunction;
import com.vincer.bean.OrderDetail;
import com.vincer.bean.OrderInfo;
...
//        env.getCheckpointConfig().setCheckpointTimeout(60000L);
        ...
        SingleOutputStreamOperator<OrderWide> orderWideDS = orderInfoWithIdKeyedStream.intervalJoin(orderDetailWithOrderIdKeyedStream)
                ...
                .process(new ProcessJoinFunction<OrderInfo, OrderDetail, OrderWide>() {
                    @Override
                    public void processElement(OrderInfo orderInfo, OrderDetail orderDetail, Context context, Collector<OrderWide> collector) {
