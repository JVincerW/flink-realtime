package com.vincer.app.dwd;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.vincer.app.func.DbSplitProcessFunction;
import com.vincer.app.func.DimSink;
import com.vincer.bean.TableProcess;
...
//        env.getCheckpointConfig().setCheckpointTimeout(60000L);
        ...
        //4.过滤
        SingleOutputStreamOperator<JSONObject> filterDS = jsonObjDS.filter((FilterFunction<JSONObject>) value -> {
            //获取data字段
