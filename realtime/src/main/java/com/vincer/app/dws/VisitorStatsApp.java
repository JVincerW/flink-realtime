package com.vincer.app.dws;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.vincer.bean.VisitorStats;
import com.vincer.utils.ClickHouseUtil;
import com.vincer.utils.MyKafkaUtil;
...
//        userJumpDS.print("UserJump>>>>>>>>>");
        ...
        SingleOutputStreamOperator<VisitorStats> svCountDS = pageLogDS.process(new ProcessFunction<String, VisitorStats>() {
            @Override
            public void processElement(String value, Context ctx, Collector<VisitorStats> out) {
        ...
        //5.分组,聚合计算
        SingleOutputStreamOperator<VisitorStats> visitorStatsSingleOutputStreamOperator = unionDS.assignTimestampsAndWatermarks(WatermarkStrategy.<VisitorStats>forBoundedOutOfOrderness(Duration.ofSeconds(10L)).withTimestampAssigner((SerializableTimestampAssigner<VisitorStats>) (element, recordTimestamp) -> element.getTs()));
        KeyedStream<VisitorStats, Tuple4<String, String, String, String>> keyedStream = visitorStatsSingleOutputStreamOperator.keyBy((KeySelector<VisitorStats, Tuple4<String, String, String, String>>) value -> Tuple4.of(value.getVc(), value.getCh(), value.getAr(), value.getIs_new()));
        ...
        //聚合操作
        SingleOutputStreamOperator<VisitorStats> result = windowedStream.reduce((ReduceFunction<VisitorStats>) (value1, value2) -> new VisitorStats("", "",
                value1.getVc(),
                value1.getCh(),
                value1.getAr(),
                value1.getIs_new(),
                ...
                System.currentTimeMillis()), (WindowFunction<VisitorStats, VisitorStats, Tuple4<String, String, String, String>, TimeWindow>) (stringStringStringStringTuple4, window, input, out) -> {
